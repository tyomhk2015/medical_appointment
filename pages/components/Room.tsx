...
const Room: React.FC<IRoomProp> = ({ participants, roomName, onClick }) => {
  return (
    <li
      ...
      className={`${
        participants >= 2 &&
        `bg-red-200 hover:bg-red-900 hover:shadow-[0_0_4px_4px_#f838387f] pointer-events-none`
      } group cursor-pointer rounded-xl bg-sky-200 p-4 transition-all duration-200 hover:cursor-pointer hover:bg-sky-400 hover:text-white hover:shadow-[0_0_8px_4px_rgba(56,189,248,0.5)]`}
    >
      <div className={`relative grid`}>
        ...
        <p className={`mt-2 flex items-center justify-end text-sm sm:text-lg`}>
